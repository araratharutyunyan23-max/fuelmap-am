...
const dict = {
  ru: {
    ...
    'onboarding.feature.alerts.installCta': 'Установи приложение — как →',
    ...
    'submit.station.empty': 'Найди свою АЗС в поиске ниже',
    ...
    'submitStation.prices.label': 'Цены за литр (֏)',
    'submitStation.prices.hint': 'Отметь цены с табло. Diesel — необязательно если не продают.',
  ...
  hy: {
    ...
    'onboarding.feature.alerts.installCta': 'Տեղադրիր հավելվածը — ինչպես →',
    ...
    'submit.station.empty': 'Որոնման մեջ գտիր քո ԲԿ-ն',
    ...
    'submitStation.prices.label': 'Գները 1 լիտրի համար (֏)',
    'submitStation.prices.hint': 'Նշիր գները ցուցատախտակից։ Diesel-ը պարտադիր չէ, եթե չեն վաճառում։',
