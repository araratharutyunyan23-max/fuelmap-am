...
const dict = {
  ru: {
    ...
    'profile.balance.howEarned': '+50 ֏ за каждую подтверждённую цену · максимум 2,000 ֏/мес',
    ...
    'profile.referral.title': 'Пригласи друга — получи 100 ֏',
    'profile.referral.subtitle': 'Друг получит 50 ֏ welcome-бонусом, ты — 100 ֏ когда он установит приложение',
    'profile.referral.your_link': 'Твоя ссылка',
    'profile.referral.copy': 'Скопировать',
    'profile.referral.copied': 'Скопировано',
    'profile.referral.share': 'Поделиться',
    'profile.referral.share_telegram': 'Telegram',
    'profile.referral.share_whatsapp': 'WhatsApp',
    'profile.referral.invited': 'Приглашено',
    'profile.referral.earned': 'Заработано',
    'profile.referral.share_text': 'Привет! Попробуй FuelMap — узнай где сегодня дешевле всего бензин в Армении. Установи по моей ссылке — оба получим бонусы 🎁',
    'onboarding.referral.banner': '🎁 Тебя пригласил {name} — получи 50 ֏ при установке',
    'onboarding.referral.banner_anon': '🎁 По реферальной ссылке: получи 50 ֏ welcome-бонус',
  ...
  hy: {
    ...
    'profile.balance.howEarned': '+50 ֏ յուրաքանչյուր հաստատված գնի համար · առավելագույնը 2,000 ֏/ամսում',
    ...
    'profile.referral.title': 'Հրավիրիր ընկերոջը — ստացիր 100 ֏',
    'profile.referral.subtitle': 'Ընկերդ ստանում է 50 ֏ welcome-բոնուս, դու՝ 100 ֏ երբ նա տեղադրի հավելվածը',
    'profile.referral.your_link': 'Քո հղումը',
    'profile.referral.copy': 'Պատճենել',
    'profile.referral.copied': 'Պատճենվեց',
    'profile.referral.share': 'Կիսվել',
    'profile.referral.share_telegram': 'Telegram',
    'profile.referral.share_whatsapp': 'WhatsApp',
    'profile.referral.invited': 'Հրավիրված',
    'profile.referral.earned': 'Վաստակած',
    'profile.referral.share_text': 'Բարև! Փորձիր FuelMap — իմացիր որտեղ է այսօր ամենաէժան բենզինը Հայաստանում: Տեղադրիր իմ հղումով՝ երկուսս էլ բոնուսներ կստանանք 🎁',
    'onboarding.referral.banner': '🎁 Քեզ հրավիրեց {name} — ստացիր 50 ֏ տեղադրման ժամանակ',
    'onboarding.referral.banner_anon': '🎁 Ռեֆերալ հղումով: ստացիր 50 ֏ welcome-բոնուս',
